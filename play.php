...
<html lang="en">
	<head>
		...
		<title>Play | ShootThis - a 2D HTML5 battle royale</title>
	...
	<body style="background-image: url('images/background.png'); color: #ffffff;">
		...
		<script src="src/bullets.js" type="text/javascript"></script>
		<script src="src/uiScene.js" type="text/javascript"></script>
